...
def getGoodreadsToReadList():
	with open('key.txt', 'r') as f:
		key = f.readline()
	userid = '13399356'
	reqtoreadshelf ="{}{}{}{}{}{}{}".format("https://www.goodreads.com/review/list?id=",userid,"&shelf=","to-read","&key=",key,"&page=1&per_page=200") 
	r = requests.get(reqtoreadshelf)
	# tree = ET.ElementTree(r.text) #returns it in str format
